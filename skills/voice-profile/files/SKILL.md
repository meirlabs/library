---
name: voice-profile
description: Writing voice and communication style guide. Use when drafting emails, Slack messages, documents, posts, proposals, or any text written as or for the user. Also use when reviewing or editing text for tone and voice. Triggers on writing, drafting, tone, voice, communication style, ghostwriting, editing for voice, messaging, review tone.
version: 1.0.0
---
